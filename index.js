...
app.listen(process.env.PORT || port, ()=> console.log('listening at 3000'));
...
async function searchPlayers_by_name(search_data){
    ...
    const url = `https://soccer.sportmonks.com/api/v2.0/players/search/${search_data}?api_token=${api_key}&include=stats,team,`;
